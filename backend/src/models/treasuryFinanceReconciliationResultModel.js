...
module.exports = sequelize.define('TreasuryFinanceReconciliationResult', {
  ...
  bank_movement_id: { type: DataTypes.UUID, allowNull: true },
  ...
  tableName: 'treasury_finance_reconciliation_results',
  underscored: true,
  timestamps: true,
});
