...
module.exports = sequelize.define('TaxFinanceReconciliationResult', {
  id: { type: DataTypes.UUID, defaultValue: DataTypes.UUIDV4, primaryKey: true },

  tax_transaction_id: { type: DataTypes.UUID, allowNull: false },
  ...
  expected_tax_minor: { type: DataTypes.BIGINT, allowNull: true },
  observed_tax_minor: { type: DataTypes.BIGINT, allowNull: true },
  currency: { type: DataTypes.STRING(3), allowNull: true },
  evaluated_at: { type: DataTypes.DATE, allowNull: false, defaultValue: DataTypes.NOW },
  metadata: { type: DataTypes.JSONB, allowNull: false, defaultValue: {} },

}, {
  tableName: 'tax_finance_reconciliation_results',
  underscored: true,
  timestamps: true,
});
